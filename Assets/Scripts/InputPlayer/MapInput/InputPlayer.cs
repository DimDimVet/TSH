...
//     version 1.7.0
//     from Assets/Scripts/InputPlayer/MapInput/InputPlayer.inputactions
//
...
public partial class @InputPlayer: IInputActionCollection2, IDisposable
{
    ...
    public struct KeyMapActions
    {
        ...
        public KeyMapActions(@InputPlayer wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputPlayer m_Wrapper;
        public UIMapActions(@InputPlayer wrapper) { m_Wrapper = wrapper; }
