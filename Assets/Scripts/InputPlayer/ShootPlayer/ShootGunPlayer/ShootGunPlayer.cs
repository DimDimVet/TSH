...
public class ShootGunPlayer : Shoot
{
    ...
    {
        //if (hashObjectDamagAcceptance != 0 & isKillObjectAcceptance) { print($"Вернули пулю {hash} c дамагом {setDamage} в объект {hashObjectDamagAcceptance}/ объект уничтожен {isKillObjectAcceptance}-цена {costTargetObject}"); }
